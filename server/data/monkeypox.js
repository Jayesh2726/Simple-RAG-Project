const monkeypox = [
  ...
  {
    id: "monkeypox-travel-precautions",
    disease: "Monkeypox",
    section: "Travel Precautions",
    content: `Before travelling, equip yourself with information about mpox, including its signs and symptoms, how it spreads, the behaviours that increase your risk of infection, and how to seek medical care at your destination. 
  ...
  {
    id: "monkeypox-sexual-transmission",
    disease: "Monkeypox",
    section: "Sexual Transmission",
    content: `Mpox can spread through close contact of any kind, including through kissing, touching, oral and penetrative vaginal or anal sex with someone who is infectious. People who have sex with multiple or new partners are most at risk.
                ...
                avoiding group sex;
                avoiding sex-on-premises venues (such as cruising bars, saunas, darkrooms, commercial sex venues or any premises where sex is exchanged for money);
                avoiding using alcohol or drugs in sexual contexts (including chemsex);
                and, where and when available, by taking up the offer of vaccines.
  ...
  {
    id: "monkeypox-isolation-guidance",
    disease: "Monkeypox",
    section: "Isolation & Protection",
    content: `If you have mpox, your healthcare provider will advise you on what to do while you recover. Follow national advice on whether you should recover at home or if you need care in a health facility.
                ...
                covering your rash with clothing or bandages (until you can isolate again – your rash will heal best if uncovered);
                opening windows throughout the home;
                ensuring you and anyone in the room with you wear well-fitting medical masks; and
  ...
  {
    id: "monkeypox-care-recovery",
    disease: "Monkeypox",
    section: "Care & Recovery",
    content: `The care someone needs will depend on their symptoms and their risk of developing more severe disease. People with mpox should follow the advice of their health care provider. Symptoms typically last 2–4 weeks and usually go away on their own or with supportive care, such as medication for pain or fever (such as analgesics and antipyretics).
  ...
  {
    id: "monkeypox-stigma-awareness",
    disease: "Monkeypox",
    section: "Stigma & Awareness",
    content: `When there is stigma or discrimination related to a medical condition, people may not seek care quickly, the quality of health care may suffer, and access to health services for the most vulnerable is reduced.
  ...
  {
    id: "monkeypox-treatment",
    disease: "Monkeypox",
    section: "Treatment",
    content: `Many years of research on therapeutics for smallpox have led to the development of products that may also be useful for treating mpox. For example, an antiviral developed to treat smallpox (tecovirimat) was approved in January 2022 by the European Medicines Agency for the treatment of mpox under exceptional circumstances. Experience with these therapeutics in the context of an outbreak of mpox is growing but still limited. For this reason, their use is usually accompanied by enrolment in a clinical trial or expanded access protocol accompanied by the collection of information that will improve knowledge on how best to use them in future.`,
    embedding: null
  },

  {
    id: "monkeypox-immunocompromised-risk",
    disease: "Monkeypox",
    section: "Immunocompromised Risk",
    content: `Persons with immune suppression are at higher risk of developing severe mpox or dying. Severe mpox can include larger, more widespread lesions (especially in the mouth, eyes and genitals), conditions such as inflammation of the heart, brain or other organs, or secondary bacterial infections of the skin or blood and lung infections.
  ...
  {
    id: "monkeypox-vaccination",
    disease: "Monkeypox",
    section: "Vaccination",
    content: `Yes, there are vaccines recommended by WHO for use against mpox. Many years of research led to the development of newer and safer vaccines for smallpox (which no longer exists as it was eradicated) and mpox.

              At present, WHO recommends use of MVA-BN or LC16 vaccines for people at risk during an outbreak of mpox. ACAM2000 may also be used for certain people based on an individual assessment when other vaccines are not available.`,
    embedding: null
  },

  {
    id: "monkeypox-pregnancy-risk",
    disease: "Monkeypox",
    section: "Pregnancy Risk",
    content: `Contracting mpox during pregnancy (which is considered a relative immunosuppressed state) can be dangerous for the fetus or newborn infant and can lead to loss of the pregnancy, stillbirth, death of the newborn, or complications for the parent. If you are pregnant, avoid close contact with anyone who has mpox. Anyone who has close contact with someone who is infectious can get mpox, regardless of who they are. If you think you have been exposed to or are showing symptoms that could be mpox, contact your healthcare provider. They will help you get tested and access the care you need. `,
    embedding: null
  },

  {
    id: "monkeypox-social-exposure",
    disease: "Monkeypox",
    section: "Social Exposure",
    content: `Anyone attending a gathering is at risk of contracting mpox if they come into close contact with someone with mpox. Mpox can spread through skin-to-skin, mouth-to-mouth, or mouth-to-skin contact (such as kissing), and by being face-to-face with someone who has mpox (such as talking or breathing close to one another, which can generate infectious respiratory particles). Mpox can also spread through contact with contaminated materials or objects such as sheets or needles.
  ...
  {
    id: "monkeypox-reinfection",
    disease: "Monkeypox",
    section: "Reinfection",
    content: `Our understanding of how long immunity following mpox lasts continues to evolve. There have been some cases of second infections reported. A few people may get mpox despite having had it before. Even if you have had mpox in the past, you should be doing everything you can to avoid getting re-infected. 

              If you have had mpox in the past and someone in your household has it now, you can protect others by being the designated caregiver, as you are more likely to have some immunity than others. However, you should still take all precautions to avoid exposure as far as possible. `,
    embedding: null
  },

  {
    id: "monkeypox-virus-variants",
    disease: "Monkeypox",
    section: "Virus Variants",
    content: `There are two broad clades of the virus: clade I and II. Clade II was behind the global mpox outbreak that began in 2022.
